...
//TEST(PenaltyKickTacticTest, robot_will_shoot_on_open_net)
//{
...
//
//    Robot enemy_goalie = Robot(1, Point(0,0), Vector(0,0), AngularVelocity 0,  )
//
//    PenaltyKickTactic penalty_kick_tactic = PenaltyKickTactic(ball, world.field(), enemy_goalie);
//
...
//}
//
//TEST(PenaltyKickTacticTest, robot_will_commit_to_a_shot_until_it_is_entirely_blocked)
//{
//    World world = ::Test::TestUtil::createBlankTestingWorld();
//    Robot robot = Robot(0, Point(0, 0), Vector(2, -1), Angle::zero(),
//                        AngularVelocity::zero(), Timestamp::fromSeconds(0));
...
//}
//
//TEST(PenaltyKickTacticTest, robot_will_align_to_ball_if_shot_is_blocked)
//{
//    World world = ::Test::TestUtil::createBlankTestingWorld();
//    Robot robot = Robot(0, Point(0, 0), Vector(2, -1), Angle::zero(),
//                        AngularVelocity::zero(), Timestamp::fromSeconds(0));
...
//}
//
//TEST(PenaltyKickTacticTest, robot_will_chip_ball_if_enemy_close_to_stealing_ball)
//{
//    World world = ::Test::TestUtil::createBlankTestingWorld();
//    Robot robot = Robot(0, Point(0, 0), Vector(2, -1), Angle::zero(),
//                        AngularVelocity::zero(), Timestamp::fromSeconds(0));
